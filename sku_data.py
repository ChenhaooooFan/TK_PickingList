...
SKU_NAMES = {
    ...
    'NOJ007': 'Cherry Glaze', 'NOX011': 'Opal Mirage', 'NOF016': 'Cinnamon Bloom',
    'NOX010': 'Twilight Muse', 'NPX020': 'Peachy Glaze', 'NPX019': 'Blossom Tart',
    'NPJ013': 'Velvet Cherry', 'NOX012': 'Harvest Glaze', 'NOJ008': 'Crystal Whisper',
    'NOF017': 'Twinkle Bow', 'NPX021': 'Twinkle Pine', 'NOF018': 'Glacier Bloom',
    'NOJ010': 'Rosé Noir', 'NPX022': 'Merry Charm', 'NPF022': 'Holiday Sparkl',
    'NOF020': 'Garnet Muse', 'NOF019': 'Twinkle Christmas', 'NOJ011': 'Snowy Comet',
    'NOX013': 'Christmas Village', 'NOJ009': 'Reindeer Glow', 'NIX002': 'Golden Orchid',
    'NPJ014': 'Snow Pixie', 'NPJ018': 'Frost Ruby', 'NPJ017': 'Starlit Rift',
    'NPF021': 'Candy Cane', 'NPJ016': 'Fairy Nectar', 'NPJ015': 'Icy Viper',
    'NOX014': 'Taro Petal', 'NVT001': 'Tool Kits', 'NVT002': 'Tool Kits',
    'NSB001': 'Storage Box', 'NOB001': 'Organizer Binder', 'NOB002': 'Organizer Binder',
    'NF001': 'Free Giveaway', 'NB001': 'Organizer Binder', 'NIF001': 'Lilac Veil',
    'NIF002': 'Gingerbread', 'NOX015': 'Glitter Doll', 'NOJ012': 'Winery Flame',
    'NOF021': 'Velvet Ribbon', 'NPX024': 'Rose Wine', 'NPX023': 'Blooming Kiss',
    'NMF001': 'Cherry Crush', 'NBX001': 'Ballet Petal', 'NMF003': 'Royal Treasure',
    'NMF002': 'Safari Princess', 'NOJ013': 'Midnight Denim', 'NOJ014': 'Imperial Frost',
    ...
    'NOF044': 'Moss Petal', 'NOF022': 'Aqua Reverie', 'NDJ001': 'Snow Knit',
    'NOF023': 'Arctic Starlight', 'NOX016': 'Cherry Ribbon', 'NOX017': 'Ruby Bow',
    'NMF004': 'Lavender Bloom', 'NDX002': 'Cloudy Knit', 'NMJ003': 'Gothic Rose',
    ...
    'NVF002': 'Dreamy Bloom', 'NOJ017': 'Floral Garden', 'NOJ016': 'Jade Blossom',
    'NVX002': 'Pastel Bloom', 'NVF008': 'Glazed Ballet', 'NWF008': 'Waikiki Blossom',
    'NWF009': 'Petal French', 'NPF023': 'Fairy Garden', 'NBJ001': 'Stone Petal',
    'NOF027': 'Acai Bloom', 'NPJ021': 'Champagne Blossom', 'NPJ020': 'Citrus Daisy',
    'NOJ018': 'Ribbon Lily', 'NVF005': 'Dreamy Sakura', 'NOF037': 'Tropical Spritz',
    'NOF039': 'Citrus Pop', 'NVJ005': 'Guava Nectar', 'NDX003': 'Meadow Petals',
    'NOX018': 'Strawberry Kiss', 'NOJ020': 'Raibow Bloom', 'NPF026': 'Seaside Sundae',
    'NVJ001': 'Prism Aura', 'NDX005': 'Midnight Glam', 'NDX004': 'Starry Tide',
    'NWF006': 'Pastel Jungle', 'NWF007': 'Peachy Seaside', 'NOJ031': 'Palm Mojito',
    'NPX027': 'Hibiscus Tide', 'NPX026': 'Ocean Yuzu', 'NWX001': 'Seashell Sorbet',
    'NOF026': 'Island Paradise', 'NPF024': 'Tropical Breeze', 'NOJ021': 'Petal Gelato',
    'AUCTION': 'Picks Any 2 Sets, 50 g, Choose Your Size', 'NVF003': 'Apricot Cream', 'NMJ005': 'Glossy Aura',
    'NGX001': 'Seafoam Jewel', 'NOF028': 'Floral Cherry', 'NTX001': 'Coraline Glow',
    'NOX020': 'Floral Drip', 'NOX019': 'Mint Petal', 'NOF030': 'Citrus Veil',
    'NOJ032': 'Lavender Prism', 'NOF031': 'Lady Cherry', 'NOF029': 'Marine Glow',
    'NDJ002': 'Aqua Blush', 'NWF001': 'Berry Bowtie', 'NTF001': 'Pastel Coast',
    'NWF005': 'Sunflower Safari', 'NOJ028': 'Cowgirl Charm', 'NOJ029': 'Pearl Tide',
    ...
    'NWF004': 'Melon Petal', 'NOF038': 'Leopard Blossom', 'NVX004': 'Glossy Violet',
    'NVX005': 'Lilac Elegance', 'NVJ002': 'Mochi Blossom', 'NOJ025': 'Petal Empress',
    'NVJ003': 'Petal Throne', 'NWX003': 'Aloha Bloom', 'NOX026': 'Papaya Bloom',
    'NOF035': 'Ocean Picnic', 'NOJ026': 'Aqua Taffy', 'NOX027': 'Coral Foam',
    'NOJ027': 'Opal Dynasty', 'NOF045': 'Indigo Petals', 'NOF046': 'Azure Splash',
    'NWF010': 'Peachy Peony', 'NOJ034': 'Aqua Mirage', 'NOJ035': 'Emerald Safari',
    ...
    'NOF050': 'Ivory Safari', 'NVJ007': 'Mocha Marble', 'NOX034': 'Crimson Charm',
    'NOX035': 'Golden Fig', 'NOF051': 'Crimson Carnival', 'NVF009': 'Toffee Camellia',
    'NVF010': 'Spooky Starlit', 'NOJ037': 'Spider Night', 'NOJ038': 'Scarlet Masque',
}

# ---- 近期新款（明细表里标粉色） ----
NEW_SKUS = {
    'NOF050', 'NOF051', 'NOJ036', 'NOJ037', 'NOJ038', 'NOX031',
    'NOX032', 'NOX033', 'NOX034', 'NOX035', 'NPX015', 'NVF009',
    'NVF010', 'NVJ006', 'NVJ007', 'NVX006', 'NWX004',
}
